    ...
    <div className="row" style={{ margin: "0%", padding: "1%" }}>
      ...
      <div className="col-md-6 col-sm-6 col-12">
        <p className="card-basic">
          ...
          gözden geçirerek uygulamaya koyar. Vizyonumuz ilkeler çerçevesinde
          müvekkillerimize, danışanlarımıza karşılaştığı problemlere, sahip
          olduğumuz tecrübe ve birikimlerle profesyonelce çözüm aramak ve
          uyuşmazlıkların en iyi, en hızlı ve en etkin şekilde kısa sürede
          bitirilmesini sağlamak ofisimizin yegâne amacıdır. Ofisimiz,
        ...
        <div className="ic">
          <p className="ic_text">
            Bugüne kadar 1200 ün üzerinde kurumsal, 1500 ü aşkın bireysel
            müşteriye hizmet verdik. Müşterilerimize üstün teknoloji ile yüksek
            marka kalitesi ve dinamik bir insan kaynağı sunduk. Markamızın
            değerini sadece Türkiye sınırları içinde değil, bölgesel ve küresel
            ölçekte de yükselttik, daha büyük hedeflerimiz var.
          </p>
        </div>
      </div>
