        ...
        <div>
            ...
            <div className="row" style={{margin:"0%",padding:"1%"}}>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                            <h3 style={{color:"orange"}}><StarRateIcon style={{fontSize:"x-large",color:"black"}}/> Gayrimenkul Yatırımı</h3>
...
Taşınamaz raporundan sonra gayrimenkulün piyasa fiyatı belirlenir. 250.000$ veya üzeri olan mülkler için güncel kur üzerinden hesaplama yapılır. Kurların hesaplaması ise Merkez Bankası tarafından yapılmaktadır.</p>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                            <h3 style={{color:"orange"}}><StarRateIcon style={{fontSize:"x-large",color:"black"}}/> Sermaye Yatırımı</h3>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12" >
                            <h3 style={{color:"orange"}}><StarRateIcon style={{fontSize:"x-large",color:"black"}}/> İstihdam Yatırımı</h3>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12" >
                            <h3 style={{color:"orange"}}><StarRateIcon style={{fontSize:"x-large",color:"black"}}/> İşinde Uzman Ekibimiz</h3>
