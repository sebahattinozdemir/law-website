           ...
           <Header
            ...
            <div className="row" style={{margin:"0%",padding:"1%"}}>
                   ...
                   <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                           <h3 style={{color:"orange"}}><EmojiPeopleIcon style={{fontSize:"x-large",color:"black"}}/> Türkiye için Çalışma İzni</h3>
                   ...
                   <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                           <h3 style={{color:"orange"}}><EmojiPeopleIcon style={{fontSize:"x-large",color:"black"}}/> Çalışma İzni Başvuru Yöntemleri</h3>
                   ...
                   <div className="col-lg-4 col-md-6 col-sm-6 col-12" >
                           <h3 style={{color:"orange"}}><EmojiPeopleIcon style={{fontSize:"x-large",color:"black"}}/> Yabancı Uyruklu Çalışanlar için Asgari Ücret</h3>
